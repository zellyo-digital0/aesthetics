...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name) || empty($email) || empty($message) || empty($treatment) || empty($tel) || empty($date)) {
    ...
    $message_body .= "Treatment: $treatment\n";
    $message_body .= "Phone Number: $tel\n";
    $message_body .= "Appointment Date: $date\n";
